...
#if 0
    ret = vvas_kernel_start (handle, "ppuufpu", input[0]->paddr[0], \
                             output[0]->paddr[0], input[0]->props.height, input[0]->props.width, \
                             sigma, kernel_priv->mem->paddr[0], input[0]->props.stride);
#endif
